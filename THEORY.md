...
$$
\begin{aligned} k_B&=0.08617333262\ \mathrm{meV/K},\\ \frac{\hbar^2}{2m_e}&=38.0998212\ \mathrm{meV\,nm^2},\\ \mu_B&=0.05788381806\ \mathrm{meV/T}. \end{aligned}
$$
...
$$
\begin{aligned} \sigma_x&=I_\tau\otimes\sigma_x^{(2)},\\ \sigma_y&=I_\tau\otimes\sigma_y^{(2)},\\ \tau_j&=\tau_j^{(2)}\otimes I_\sigma. \end{aligned}
$$
