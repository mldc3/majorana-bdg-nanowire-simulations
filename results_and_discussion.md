...
![Kitaev bulk bands](fig_kitaev_bulk_bands.png)
...
![Kitaev phase diagram](fig_kitaev_phase_diagram.png)
...
![Kitaev finite spectrum versus chemical potential](fig_kitaev_finite_spectrum_vs_mu.png)
...
![Kitaev minimum energy versus chemical potential](fig_kitaev_min_energy_vs_mu.png)
...
![Kitaev LDOS](fig_kitaev_ldos_three_regimes.png)
...
![Kitaev zero mode comparison](fig_kitaev_zero_mode_trivial_topological.png)
...
![Kitaev Majorana decomposition](fig_kitaev_majorana_decomposition.png)
...
![Kitaev particle-hole content](fig_kitaev_particle_hole_content.png)
...
![Kitaev splitting versus length](fig_kitaev_splitting_vs_length.png)
...
![Kitaev pairing localization](fig_kitaev_pairing_localization.png)
...
![Self-consistent convergence](fig_selfconsistent_convergence.png)
...
![Self-consistent gap profile](fig_selfconsistent_gap_profile.png)
...
![Self-consistent bulk bands](fig_selfconsistent_bulk_bands.png)
...
![Self-consistent spectrum versus Zeeman](fig_selfconsistent_spectrum_vs_zeeman.png)
...
![Self-consistent bulk gap versus Zeeman](fig_selfconsistent_bulk_gap_vs_zeeman.png)
...
![Self-consistent LDOS](fig_selfconsistent_ldos_three_regimes.png)
...
![Self-consistent mode comparison](fig_selfconsistent_mode_trivial_topological.png)
...
![Self-consistent Majoranas](fig_selfconsistent_majoranas.png)
...
![Self-consistent particle-hole content](fig_selfconsistent_particle_hole.png)
...
![Self-consistent splitting versus length](fig_selfconsistent_splitting_vs_length.png)
...
![Self-consistent mu-Zeeman map](fig_selfconsistent_mu_zeeman_map.png)
...
![Self-consistent interaction-localization comparison](fig_selfconsistent_interaction_localization.png)
...
![Self-consistent gap versus interaction](fig_selfconsistent_gap_vs_interaction.png)
...
![Realistic nanowire profiles](fig_realistic_profiles.png)
...
![Realistic superconducting coverage](fig_realistic_superconducting_coverage.png)
...
![Realistic bulk bands](fig_realistic_bulk_bands.png)
...
![Realistic spectrum versus Zeeman](fig_realistic_spectrum_vs_zeeman.png)
...
![Realistic spectrum versus chemical potential](fig_realistic_spectrum_vs_mu.png)
...
![Realistic phase diagram](fig_realistic_phase_mu_zeeman.png)
...
![Realistic log minimum-energy map](fig_realistic_map_log_minE.png)
...
![Realistic bulk-edge comparison](fig_realistic_bulk_edge_comparison.png)
...
![Realistic bulk gap](fig_realistic_bulk_gap.png)
...
![Realistic LDOS](fig_realistic_ldos.png)
...
![Realistic zero-state density](fig_realistic_zero_state.png)
...
![Realistic Majoranas](fig_realistic_majoranas.png)
...
![Realistic particle-hole content](fig_realistic_particle_hole.png)
...
![Realistic BdG charge](fig_realistic_charge_bdg.png)
...
![Realistic spin diagnostic](fig_realistic_spin_mode.png)
...
![Realistic Rashba sweep](fig_realistic_rashba_sweep.png)
...
![Realistic alpha-Zeeman map](fig_realistic_alpha_zeeman.png)
...
![Realistic gap localization](fig_realistic_gap_localization.png)
...
![Realistic localization length](fig_realistic_localization_length.png)
...
![Realistic mesh convergence](fig_realistic_convergence_mesh.png)
...
![Realistic barrier sweep](fig_realistic_barrier_sweep.png)
...
![Realistic inhomogeneity](fig_realistic_inhomogeneity.png)
...
![Quasi-Majorana profiles](fig_quasi_profiles.png)
...
![Quasi-Majorana bulk gap criterion](fig_quasi_bulk_gap_criterion.png)
...
![Quasi-Majorana bulk bands](fig_quasi_bulk_bands.png)
...
![Quasi-Majorana near-zero state](fig_quasi_state_near_zero.png)
...
![Quasi-Majorana decomposition](fig_quasi_majorana_decomposition.png)
