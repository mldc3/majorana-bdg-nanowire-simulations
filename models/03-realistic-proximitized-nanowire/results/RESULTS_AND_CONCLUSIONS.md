...
## Induced pairing and renormalization

![Proximity profiles used in the simulation. The superconducting coverage determines the local interface coupling, induced pairing and quasiparticle-weight factor.](figures/01_proximity_profiles.png)

*Proximity profiles used in the simulation. The superconducting coverage determines the local interface coupling $\gamma(x)$, induced pairing $\Delta_{\mathrm{ind}}(x)$ and quasiparticle-weight factor $Z(x)$.*
...
The induced gap is expected to reach a finite plateau in the covered region, whereas $Z<1$ there reflects the reduction of the semiconductor quasiparticle weight. At the ends, $\gamma\to0$, $\Delta_{\mathrm{ind}}\to0$ and $Z\to1$, so the wire becomes approximately normal.
...
![Convergence of the Hartree iteration in the three representative regimes.](figures/02_hartree_convergence.png)

*Convergence of the Hartree iteration in the three representative regimes.*
...
## External, Hartree and effective potentials

![Potentials in the trivial, transition and topological regimes.](figures/03_potential_profiles.png)

*Potentials in the trivial, transition and topological regimes. The dotted curve is $V_{\mathrm{ext}}(x)$, the dashed curve is the Hartree correction $U_H(x)$ and the continuous curve is $V_{\mathrm{eff}}(x)=V_{\mathrm{ext}}(x)+U_H(x)$.*
...
![Self-consistent density in the trivial, transition and topological regimes.](figures/04_self_consistent_density.png)

*Self-consistent density in the trivial, transition and topological regimes.*
...
## Complete effective-band spectrum

![Effective homogeneous bulk bands in the trivial, transition and topological regimes.](figures/05_bulk_bands_full.png)

*Effective homogeneous bulk bands in the trivial, transition and topological regimes.*
...
## Continuous and discrete bulk spectra

![Comparison of the continuous evaluation of the homogeneous lattice Hamiltonian with values sampled at the discrete momenta of the spatial mesh.](figures/06_bulk_bands_continuous_discrete.png)

*Comparison of the continuous evaluation of the homogeneous lattice Hamiltonian with values sampled at the discrete momenta of the spatial mesh.*
...
![Subgap zoom of the continuous/discrete bulk comparison.](figures/07_bulk_bands_zoom.png)

*Subgap zoom of the continuous/discrete bulk comparison.*
...
![Low-energy finite-wire spectrum as a function of Zeeman energy. The dashed line marks the homogeneous critical estimate and the shaded region is the expected topological interval.](figures/08_finite_spectrum_zeeman.png)

*Low-energy finite-wire spectrum as a function of Zeeman energy. The dashed line marks the homogeneous critical estimate and the shaded region is the expected topological interval.*
...
$$
E=\pm\varepsilon_M,\qquad \varepsilon_M\sim A\mathrm{e}^{-L/\xi}\cos(k_FL+\phi),
$$
...
![Zoom of the finite spectrum near zero energy as the Zeeman field crosses the transition.](figures/09_finite_spectrum_zeeman_zoom.png)

*Zoom of the finite spectrum near zero energy as the Zeeman field crosses the transition.*
...
![Low-energy finite spectrum as a function of chemical potential at fixed topological Zeeman field. Dashed lines delimit the estimated topological window.](figures/10_finite_spectrum_mu.png)

*Low-energy finite spectrum as a function of chemical potential at fixed topological Zeeman field. Dashed lines delimit the estimated topological window.*

### What is calculated and why

The Zeeman field is held in the topological regime while the chemical potential is swept. The homogeneous criterion predicts a finite interval $\mu_c^-<\mu<\mu_c^+$. The purpose is to check whether the near-zero signal is tied to this interval rather than to one specially tuned value of $\mu$.
...
## Chemical-potential-sweep zoom

![Zoom of the near-zero spectrum across the chemical-potential window.](figures/11_finite_spectrum_mu_zoom.png)

*Zoom of the near-zero spectrum across the chemical-potential window.*
...
![Symmetric position- and energy-resolved BdG spectral density near zero for the three regimes.](figures/12_symmetric_ldos.png)

*Symmetric position- and energy-resolved BdG spectral density near zero for the three regimes.*
...
$$
\rho(x_i,E)=\sum_{E_n>0}\rho_n(x_i) \left[\mathcal L_\eta(E-E_n)+\mathcal L_\eta(E+E_n)\right].
$$
...
## Majorana-like left/right decomposition

![Decomposition of the near-zero BdG subspace into components maximally localized toward the left and right halves of the nanowire.](figures/13_majorana_decomposition.png)

*Decomposition of the near-zero BdG subspace into components maximally localized toward the left and right halves of the nanowire.*
...
![Electron density, hole density and total density of the positive BdG state closest to zero in the three regimes.](figures/14_particle_hole_content.png)

*Electron density, hole density and total density of the positive BdG state closest to zero in the three regimes.*
...
$$
\rho_e(i)=|u_{n\uparrow}(i)|^2+|u_{n\downarrow}(i)|^2,
$$
...
$$
\rho_h(i)=|v_{n\uparrow}(i)|^2+|v_{n\downarrow}(i)|^2.
$$
